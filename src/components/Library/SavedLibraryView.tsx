...
import { User as UserIcon, Clock, ChevronRight, Heart, Search, Filter, Hash, Bookmark } from 'lucide-react';
    ...
    <div className="flex-1 bg-slate-950 overflow-y-auto relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-12 relative z-10">
        <header className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-extrabold text-white tracking-tight mb-3">Your Library</h1>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Novels you've saved and loved from the community.
          </p>
        </header>
        ...
        <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-2xl p-4 mb-10 flex flex-col md:flex-row items-center gap-4 shadow-xl">
          <div className="flex-1 relative w-full">
            ...
            <input 
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-11 pr-4 py-3 text-sm text-slate-200 focus:outline-none focus:border-rose-500 focus:ring-1 focus:ring-rose-500 transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="relative flex-1 md:w-48">
              ...
              <select 
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-8 py-3 text-sm text-slate-300 focus:outline-none focus:border-rose-500 appearance-none cursor-pointer"
              >
            ...
            <select 
              ...
              className="bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-300 focus:outline-none focus:border-rose-500 appearance-none cursor-pointer"
            >
          ...
          if (filteredProjects.length === 0) {
            return (
              <div className="text-center py-24 bg-slate-900/30 rounded-3xl border border-slate-800/50 backdrop-blur-sm">
                <Bookmark className="w-16 h-16 text-slate-700 mx-auto mb-6 stroke-[1]" />
                <h3 className="text-xl font-semibold text-slate-300 mb-2">No saved novels found</h3>
                <p className="text-slate-500 max-w-md mx-auto">
                  {savedProjects.length === 0 
                    ? "You haven't saved any novels yet. Go to the Public Library to discover some!"
          ...
          return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-slate-100 mb-2 group-hover:text-rose-300 transition-colors line-clamp-2">
                  {project.title}
                </h3>
                ...
                <div className="mt-auto pt-4 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-500">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-1 text-rose-400 font-semibold opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300">
